...
const {loginService,signupService,getRestaurantUserService,updateRestaurantById, userSignUp,userLogin,getUserByID,updateUserById,fetchAllUsers,fetchAllRestaurants,DeliveryBoyloginService, DeliveryBoysignupService, getDeliveryBoyById, updateDeliveryBoyById, deleteDeliveryBoyById, getAllDeliveryBoys} = require("../Service/AuthService")
...
router.post("/updateRestaurantById",updateRestaurantById)
